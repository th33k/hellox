...
const EarthCanvas = ({ 
  toggleSidebar, 
  handleZoom, 
  // earthTextureUrl = 'https://github.com/th33k/hellox/blob/main/src/assets/earthmap1k.jpg', 
  cloudTextureUrl = 'https://github.com/th33k/hellox/blob/main/src/assets/earthCloud.png',
  galaxyTextureUrl = 'https://github.com/th33k/hellox/blob/main/src/assets/galaxy.png',
  earthTextureUrl = 'https://github.com/th33k/hellox/blob/main/src/assets/2k_earth_daymap.jpg',
  lightIntensity = 100,
